...
prolong_buttons = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="10 дней", callback_data='ptolong_time 10'), InlineKeyboardButton(text="30 дней", callback_data='ptolong_time 30')],
